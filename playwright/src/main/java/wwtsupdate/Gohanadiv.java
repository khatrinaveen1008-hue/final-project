...
import base.LoginUtil;

public class Gohanadiv {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (Playwright playwright = Playwright.create()) {
            ...
            LoginUtil.login(page);


            page.locator("img[src='/MIS/Content/assets/images/WaterMonitoringNew.jpg']").click();
            page.waitForTimeout(2000);

            page.navigate("https://systems.hid.gov.in/twp/UI/AddWWTStatusDaily.aspx");
                    ...
                    for (int i = 1; i < count; i++) {
                        try {
                            ...
                            for (String line : fullText.split("\n")) {
                                line = line.trim();
                                if (line.startsWith("WWT Name :")) {
                                    sitePondName = line.replace("WWT Name :", "").trim();
                                    break;
                                }
                            }
